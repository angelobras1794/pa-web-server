...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class RequestHandlerTest {
    ...
    public void testHtmlSearcher_FileExists() {
        ...
        Path actualPath = requestHandler.htmlSearcher();
    ...
    public void testFindAllFiles() {
        List<Path> indexFiles = requestHandler.findAllFiles();
        assertFalse(indexFiles.isEmpty());
        for (Path path : indexFiles) {
            assertEquals("index.html", path.getFileName().toString());
        }
    }
